      ...
      ((l.getUtils = v),
        (l.prototype = {
          ...
          update: function () {
            this.dpoints = [];
            for (
              var t = this.points, n = t.length, r = n - 1;
              n > 1;
              n--, r--
            ) {
          ...
          on: function (t, n) {
            n = n || 5;
            for (
              var r, i = this.getLUT(), e = [], o = 0, s = 0;
              s < i.length;
              s++
            )
              ((r = i[s]),
                y.dist(r, t) < n && (e.push(r), (o += s / i.length)));
          ...
          compute: function (t) {
            ...
            if (this.order < 4) {
              ...
              return (
                this._3d &&
                  (f.z = i * n[0].z + e * n[1].z + o * n[2].z + a * n[3].z),
                f
              );
            }
            for (
              var c = JSON.parse(JSON.stringify(this.points));
              c.length > 1;
              ...
              for (var h = 0; h < c.length - 1; h++)
                ((c[h] = {
                  ...
                  'undefined' != typeof c[h].z &&
                    (c[h] = c[h].z + (c[h + 1].z - c[h].z) * t));
          ...
          raise: function () {
            for (
              var t, n, r, i = this.points, e = [i[0]], o = i.length, t = 1;
              o > t;
              t++
            )
              ((n = i[t]),
          ...
          derivative: function (t) {
            ...
            return (
              this._3d && (s.z = n * o[0].z + r * o[1].z + e * o[2].z),
              s
            );
          },
          ...
          hull: function (t) {
            ...
            for (
              e[o++] = r[0],
                e[o++] = r[1],
                e[o++] = r[2],
                3 === this.order && (e[o++] = r[3]);
              r.length > 1;

            ) {
              for (i = [], s = 0, u = r.length - 1; u > s; s++)
          ...
          scale: function (t) {
            var n = this.order,
              r = !1;
            if (('function' == typeof t && (r = t), r && 2 === n))
          ...
          outline: function (t, n, r, i) {
            ...
            (s.forEach(function (o) {
              ((_ = o.length()),
                x
                  ? (a.push(o.scale(e(t, r, h, c, _))),
                    f.push(o.scale(e(-n, -i, h, c, _))))
          ...
          outlineshapes: function (t, n, r) {
            n = n || t;
            for (
              var i = this.outline(t, n).curves, e = [], o = 1, s = i.length;
              s / 2 > o;
              o++
            ) {
        ...
        v = {
          ...
          length: function (t) {
            var n,
              ...
              o = v.Tvalues.length;
            for (n = 0; o > n; n++)
              ((r = i * v.Tvalues[n] + i), (e += v.Cvalues[n] * v.arcfn(r, t)));
            return i * e;
          },
