...
var l = (s, t) => ds(s, 'name', { value: t, configurable: !0 });
var P = (s, t, e, r) => {
  for (
    var i = r > 1 ? void 0 : r ? ln(t, e) : t, n = s.length - 1, o;
    n >= 0;
    n--
  )
...
var Oe = class {
        ...
        (i instanceof File
          ...
          : i instanceof Blob
            ...
            : i instanceof ArrayBuffer
              ? (o = new File([i], n))
              : (o = new File([i ?? ''], n, { type: 'text/plain' })),
          this.files.set(n, o));
      }
    }
    static {
      l(this, 'MemoryFileSystem');
    }
    *list() {
      yield* this.files.keys();
    }
    async has(e) {
      if (this.files.has(e)) return !0;
      let r = le(e);
      return this.files.has(r);
    }
    async get(e) {
      let r = this.files.get(e) ?? this.files.get(le(e));
      if (!r) throw new Error(`File ${e} not found!`);
      return r;
    }
    async download(e) {
  ...
  G2 = class extends Oe {
    ...
    static {
      l(this, 'CombinedFileSystem');
    }
    *list() {
      let e = new Set();
      for (let r of this.file_systems)
        for (let i of r.list()) e.has(i) || (e.add(i), yield i);
    }
    async has(e) {
      for (let r of this.file_systems) if (await r.has(e)) return !0;
      return !1;
    }
    async get(e) {
      for (let r of this.file_systems) if (await r.has(e)) return r.get(e);
    ...
    (t.addEventListener(
      ...
      t.addEventListener(
        ...
        async (r) => {
          ...
          if (!i) return;
          let n = await H2.fromDataTransfer(i);
          e(n);
        },
        !1
      ));
...
l(bs, 'requestContext');
function _s(s, t, e) {
  s.addEventListener(J2.type, (r) => {
    let i = r;
    i.context_name == t && i.callback(e);
  });
}
l(_s, 'provideContext');
async function cn(s, t) {
  return (await bs(s, t))();
}
l(cn, 'requestLazyContext');
async function Rn(s, t, e) {
  _s(s, t, e);
}
l(Rn, 'provideLazyContext');
function Ms(s) {
  return class extends s {
    ...
    async requestContext(e) {
      return await bs(this, e);
    }
    provideContext(e, r) {
      _s(this, e, r);
    }
    async requestLazyContext(e) {
      return await cn(this, e);
    }
...
var Ns = new Map(),
  Ve = class {
    ...
    get stylesheet() {
      let t = Ns.get(this.css_string);
      return (
        t == null &&
          ((t = new CSSStyleSheet()),
          t.replaceSync(this.css_string),
          Ns.set(this.css_string, t)),
        t
      );
    }
  };
function T(s, ...t) {
  ...
  for (let r = 0; r < s.length - 1; r++) {
    e += s[r];
    let i = t[r];
    if (i instanceof Ve) e += i.css_string;
    else if (ce(i)) e += String(i);
    else
      throw new Error(
        'Only CSS or number variables allowed in css template literal'
      );
  }
  return ((e += s.at(-1)), new Ve(e));
}
l(T, 'css');
function Vs(s, t) {
...
l(I2, 'as_array');
function gs(s) {
  return z3(s) ? s : It(s) ? Array.from(s) : [s];
}
l(gs, 'iterable_as_array');
var un = new Intl.Collator(void 0, { numeric: !0 });
function he(s, t) {
  return s.slice().sort((e, r) => un.compare(t(e), t(r)));
}
l(he, 'sorted_by_numeric_strings');
var ot = class {
  constructor() {
...
function hn(s, t) {
  ...
  for (let i = 0; i < s.length - 1; i++)
    (e.push(s[i]),
      t[i] instanceof q3 ? e.push(t[i].text) : e.push(`$$:${i}:$$`));
  return (e.push(s[s.length - 1]), e.join(''));
}
l(hn, 'prepare_template_html');
function dn(s, t) {
  ...
  for (; (r = e.nextNode()) !== null; )
    if (r.nodeType == Node.TEXT_NODE) mn(r.parentNode, r, t);
...
l(dn, 'apply_values_to_tree');
function mn(s, t, e) {
  if (!s) return;
  let r = t.data.split(er);
  if (!(!r || r.length == 1)) {
    if (pn(s) && ['script', 'style'].includes(s.localName))
    ...
    for (let i = 0; i < r.length; i++) {
      ...
      if (n)
        if (i % 2 == 0) s.insertBefore(new Text(n), t);
          ...
          for (let o of Ps(e[parseInt(n, 10)]))
            o != null && s.insertBefore(o, t);
    }
    t.data = '';
  }
}
l(mn, 'apply_content_value');
function bn(s, t, e) {
  let r = t.value.split(er);
  if (!(!r || r.length == 1)) {
    ...
    t.value = t.value.replaceAll(er, (i, n) => {
      let o = e[parseInt(n, 10)];
      return tr(o, t.localName);
    });
  }
}
l(bn, 'apply_attribute_value');
function* Ps(s) {
  if (!(s == null || s == null)) {
    if (j3(s)) {
    ...
    if (It(s)) {
      for (let t of s) yield* Ps(t);
      return;
    }
    throw new Error(`Invalid value ${s}`);
  }
}
l(Ps, 'convert_value_for_content');
function tr(s, t) {
  if (s == null || s == null) return '';
  if (j3(s)) return s.toString();
  if (It(s))
    return Array.from(s)
      .map((e) => tr(e, t))
      .join('');
...
l(tr, 'convert_value_for_attr');
var Ue = class extends HTMLElement {
  constructor() {
    super();
    this.updateComplete = new fe();
    this.disposables = new ot();
  ...
  renderedCallback() {}
  async update() {
    for (this.updateComplete = new fe(); this.renderRoot.firstChild; )
  ...
  #e() {
    ...
    return (
      ...
      e.styles && Vs(this.shadowRoot ?? document, I2(e.styles)),
      (async () => {
        let r = this.render();
...
function L(s) {
  let t = s.converter?.to_attribute ?? Ws.to_attribute,
    e = s.converter?.from_attribute ?? Ws.from_attribute;
  return (r, i) => {
    let n = i.replace('_', '-'),
      o = !1;
...
window.customElements.define('kc-ui-icon', kt);
...
(P([Q('button', !0)], me.prototype, 'button', 2),
  P([Q('button_icon', !0)], me.prototype, 'button_icon', 2),
  P([L({ type: String })], me.prototype, 'name', 2),
  P([L({ type: String })], me.prototype, 'icon', 2),
  P([L({ type: String })], me.prototype, 'variant', 2),
  P([L({ type: Boolean })], me.prototype, 'disabled', 2),
  P([L({ type: Boolean })], me.prototype, 'selected', 2));
window.customElements.define('kc-ui-button', me);
var at = class extends N {
  ...
  initialContentCallback() {
    (this.collapsed
      ...
      : this.change_activity(this.#i),
      de(this.renderRoot, 'kc-ui-button', 'click', (r, i) => {
        this.change_activity(i.name, !0);
      }),
      new MutationObserver(async (r) => {
        (await this.update(),
          this.#e &&
            !this.#r.includes(this.#e) &&
            this.change_activity(this.#i));
...
(P([Q('.activities', !0)], at.prototype, 'activities_container', 2),
  P([Zs('kc-ui-button')], at.prototype, 'buttons', 2),
  P([L({ type: Boolean })], at.prototype, 'collapsed', 2));
window.customElements.define('kc-ui-activity-side-bar', at);
...
window.customElements.define('kc-ui-app', rr);
...
window.customElements.define('kc-ui-control-list', ir);
...
window.customElements.define('kc-ui-control-list-item', sr);
function lt(s, t, e) {
  let r = e.value,
    i = !1;
  e.value = function (...n) {
...
l(lt, 'no_self_recursion');
var k2 = class extends N {
  static {
  ...
  initialContentCallback() {
    (super.initialContentCallback(),
      de(this, 'kc-ui-menu-item', 'click', (t, e) => {
...
P([lt], k2.prototype, 'send_selected_event', 1);
window.customElements.define('kc-ui-menu', k2);
...
(P([L({ type: String })], Fe.prototype, 'name', 2),
  P([L({ type: String })], Fe.prototype, 'icon', 2),
  P([L({ type: Boolean })], Fe.prototype, 'selected', 2),
  P([L({ type: Boolean })], Fe.prototype, 'disabled', 2));
window.customElements.define('kc-ui-menu-item', Fe);
...
window.customElements.define('kc-ui-menu-label', nr);
var At = class extends N {
  constructor() {
    super();
...
(P([L({ type: Boolean })], At.prototype, 'visible', 2),
  P([L({ type: Number })], At.prototype, 'mouseout_padding', 2));
window.customElements.define('kc-ui-dropdown', At);
...
window.customElements.define('kc-ui-filtered-list', or);
...
window.customElements.define('kc-ui-floating-toolbar', ar);
  ...
  initialContentCallback() {
    (this.addEventListener('click', () => {
      ...
      (this.#e = new IntersectionObserver((t) => {
        for (let e of t)
          (console.log(e),
            e.isIntersecting || this.classList.remove('has-focus'));
      })),
      this.#e.observe(this),
      this.addDisposable({
        dispose: () => {
...
window.customElements.define('kc-ui-focus-overlay', lr);
...
window.customElements.define('kc-ui-panel', cr);
...
window.customElements.define('kc-ui-panel-title', Rr);
...
window.customElements.define('kc-ui-panel-body', ur);
...
window.customElements.define('kc-ui-panel-label', pr);
...
window.customElements.define('kc-ui-property-list', hr);
...
P([L({ type: String })], A2.prototype, 'name', 2);
window.customElements.define('kc-ui-property-list-item', A2);
...
(P([L({ type: String })], ge.prototype, 'name', 2),
  P([L({ type: String })], ge.prototype, 'min', 2),
  P([L({ type: String })], ge.prototype, 'max', 2),
  P([L({ type: String })], ge.prototype, 'step', 2),
  P([L({ type: Boolean })], ge.prototype, 'disabled', 2),
  P([Q('input', !0)], ge.prototype, 'input', 2));
window.customElements.define('kc-ui-range', ge);
...
window.customElements.define('kc-ui-resizer', dr);
var Ss = T`
    :host(.grow) {
        flex-basis: unset;
        flex-grow: 999;
...
window.customElements.define('kc-ui-view', mr);
...
window.customElements.define('kc-ui-split-view', br);
...
(P([Q('input', !0)], Ct.prototype, 'input', 2),
  P([Q('button', !0)], Ct.prototype, 'button', 2));
window.customElements.define('kc-ui-text-filter-input', Ct);
...
(P([L({ type: String })], Dt.prototype, 'icon', 2),
  P([L({ type: Boolean })], Dt.prototype, 'visible', 2));
window.customElements.define('kc-ui-toggle-menu', Dt);
var Ts = `<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs/><symbol id="pcb_file" viewBox="0 0 48 48">
...
var Ls = URL.createObjectURL(new Blob([Ts], { type: 'image/svg+xml' }));
function Bt(s) {
...
function Nn(s, t, e) {
  ...
  let f = p * m * (s.y - e.y),
    ...
    nt = f + S - v,
    Xe = Math.sqrt(V * V + y * y + te * te),
    C = (f + S - v) / X,
    se = C * Math.sqrt(((Xe / nt) * Xe) / nt + ((x / X) * x) / X),
    B3 = (s.x + t.x) / 2 - C,
    os = Math.sqrt(1 / 8 + se * se),
    as = B3 / p,
    ls = as * Math.sqrt(((os / B3) * os) / B3 + ((b / p) * b) / p),
    Et = as + (s.y + t.y) / 2,
    cs = Math.sqrt(ls * ls + 1 / 8),
    Rs = Math.floor((C + 50) / 100) * 100,
    us = Math.floor((Et + 50) / 100) * 100,
    ps = Math.floor((C + 5) / 10) * 10,
    hs = Math.floor((Et + 5) / 10) * 10;
  return (
    Math.abs(Rs - C) < se && Math.abs(us - Et) < cs
      ? ((i.x = Rs), (i.y = us))
      : Math.abs(ps - C) < se && Math.abs(hs - Et) < cs
        ? ((i.x = ps), (i.y = hs))
        : ((i.x = C), (i.y = Et)),
    i
  );
}
l(Nn, 'arc_center_from_three_points');
var C2 = class {
...
var h = class s {
  ...
  desaturate() {
    ...
    let [t, e, r] = Vn(this.r, this.g, this.b);
    return new s(...gn(t, 0, r));
  }
  mix(t, e) {
    return new s(
      t.r * (1 - e) + this.r * e,
...
Context: ${zt(s, o)}`);
      ...
      if (_r(c)) continue;
      if (c === ')' || D2(c))
        (yield new E(E.ATOM, s.substring(i, o)),
          (r = 0),
          c === ')' && (yield e));
      else
...
function xs(s) {
  let t = Pn(s);
  return Array.from(Fs(t));
}
l(xs, 'listify');
var Mr = new Re('kicanvas:parser');
var R = {
    any(s, t, e) {
      return e;
    },
...
function g(s, ...t) {
  G(s) &&
    (Mr.info(`Parsing expression with ${s.length} chars`),
    (s = xs(s)),
  ...
  if (r) {
    ...
    if (!o.includes(c))
      throw new Error(
        `Expression must start with ${r.name} found ${c} in ${s}`
      );
    s = s.slice(1);
  }
  let n = {};
  ...
  for (let o of s) {
    ...
    if ((!c && Array.isArray(o) && (c = e.get(o[0])), !c)) {
      Mr.warn(`No def found for element ${o} in expression ${s}`);
      continue;
    }
    ...
    constructor(t, e) {
      ...
      Object.assign(
        ...
        g(
          ...
          a.item('paper', ct),
          a.item('title_block', xe),
          a.list('layers', R.item(Pr)),
          a.item('setup', Wr),
          a.mapped_collection(
            'properties',
            'property',
          ...
          a.collection('nets', 'net', R.item(z2)),
          a.collection('footprints', 'footprint', R.item(Qe, this)),
          a.collection('zones', 'zone', R.item(Rt)),
          a.collection('segments', 'segment', R.item(qt)),
          a.collection('segments', 'arc', R.item(e2)),
          a.collection('vias', 'via', R.item(t2)),
          a.collection('drawings', 'dimension', R.item(r2, this)),
          a.collection('drawings', 'gr_line', R.item(ut)),
          a.collection('drawings', 'gr_circle', R.item(pt)),
          a.collection('drawings', 'gr_arc', R.item(ht)),
          a.collection('drawings', 'gr_poly', R.item(dt)),
          a.collection('drawings', 'gr_rect', R.item(mt)),
          a.collection('drawings', 'gr_text', R.item(_t, this)),
          a.collection('groups', 'group', R.item(Qr))
        )
      );
    }
    static {
    ...
    constructor(t, e) {
      ...
      Object.assign(
        ...
        g(
          ...
          a.item('keepout', Vr),
          a.item('fill', gr),
          a.collection('polygons', 'polygon', R.item(We)),
          a.collection('filled_polygons', 'filled_polygon', R.item(Xr)),
          a.pair('tstamp', R.string)
        )
      );
    }
    ...
    constructor(t) {
      ...
      Object.assign(
        ...
        g(
          ...
          a.collection('layers', 'layer', R.item(Tr))
        )
      );
    }
    static {
    ...
    constructor(t, e) {
      ...
      Object.assign(
        ...
        g(
          ...
          a.collection('drawings', 'fp_line', R.item(i2, this)),
          a.collection('drawings', 'fp_circle', R.item(s2, this)),
          a.collection('drawings', 'fp_arc', R.item(n2, this)),
          a.collection('drawings', 'fp_poly', R.item(o2, this)),
          a.collection('drawings', 'fp_rect', R.item(a2, this)),
          a.collection('drawings', 'fp_text', R.item($e, this)),
          a.collection('zones', 'zone', R.item(Rt, this)),
          a.collection('models', 'model', R.item(xr)),
          a.collection('pads', 'pad', R.item(l2, this))
        )
      );
    ...
    *items() {
    ...
    get bbox() {
      if (!this.#t) {
        ...
        for (let r of this.drawings)
          r instanceof $e || (t = O.combine([t, r.bbox.transform(e)]));
  ...
  bt = class {
    ...
    static {
      this.common_expr_defs = [
        ...
        a.pair('tstamp', R.string),
        a.item('effects', J),
        a.item('render_cache', Or),
      ];
    }
    get shown_text() {
      return Be(this.text, this.parent);
    }
  },
  $e = class extends bt {
    constructor(e, r) {
        ...
        a.expr(
          ...
          (i, n, o) =>
            g(
              o,
              a.start('primitives'),
              a.collection('items', 'gr_line', R.item(ut, this)),
              a.collection('items', 'gr_circle', R.item(pt, this)),
              a.collection('items', 'gr_arc', R.item(ht, this)),
              a.collection('items', 'gr_rect', R.item(mt, this)),
              a.collection('items', 'gr_poly', R.item(dt, this))
            )?.items
        )
      );
...
var A = {
    ...
    constructor(t, e) {
      ...
      (Object.assign(
        ...
        g(
          ...
          a.item('paper', ct),
          a.item('title_block', xe),
          a.item('lib_symbols', Hr, this),
          a.collection('wires', 'wire', R.item(c2)),
          a.collection('buses', 'bus', R.item(R2)),
          a.collection('bus_entries', 'bus_entry', R.item(u2)),
          a.collection('bus_aliases', 'bus_alias', R.item(vr)),
          a.collection('junctions', 'junction', R.item(p2)),
          a.collection('no_connects', 'no_connect', R.item(h2)),
          a.collection('net_labels', 'label', R.item(b2)),
          a.collection('global_labels', 'global_label', R.item(_2, this)),
          a.collection(
            'hierarchical_labels',
            'hierarchical_label',
            R.item(je, this)
          ...
          a.collection('drawings', 'polyline', R.item(ft, this)),
          a.collection('drawings', 'rectangle', R.item(Nt, this)),
          a.collection('drawings', 'arc', R.item(Mt, this)),
          a.collection('drawings', 'text', R.item(Vt, this)),
          a.collection('images', 'image', R.item(Yr)),
          a.item('sheet_instances', Ir),
          a.item('symbol_instances', Ar),
  ...
  ft = class extends ee {
    constructor(e, r) {
      ...
      Object.assign(
        this,
        g(e, a.start('polyline'), a.list('pts', R.vec2), ...ee.common_expr_defs)
      );
    }
    static {
      l(this, 'Polyline');
...
`) && (this.text = this.text.slice(0, this.text.length - 1)));
  ...
  m2 = class extends Vt {
    constructor(e, r) {
      super(e, r);
      this.parent = r;
      (r instanceof gt || r instanceof re) && (this.at.rotation /= 10);
    }
    static {
      l(this, 'LibText');
    }
  ...
  b2 = class extends we {
    ...
    constructor(t) {
      (super(),
        Object.assign(this, g(t, a.start('label'), ...we.common_expr_defs)));
    }
  },
  _2 = class extends we {
    constructor(e) {
      ...
      Object.assign(
        ...
        g(
          ...
          a.collection('properties', 'property', R.item(Ye))
        )
      );
    }
    static {
    ...
    constructor(t, e) {
      ...
      Object.assign(
        ...
        g(
          t,
          a.start('lib_symbols'),
          a.collection('symbols', 'symbol', R.item(gt, e))
        )
      );
    ...
    constructor(t, e) {
      ...
      Object.assign(
        ...
        g(
          ...
          a.collection('pins', 'pin', R.item(Gr, this)),
          a.collection('children', 'symbol', R.item(s, this)),
          a.collection('drawings', 'arc', R.item(Mt, this)),
          a.collection('drawings', 'bezier', R.item(wr, this)),
          a.collection('drawings', 'circle', R.item(d2, this)),
          a.collection('drawings', 'polyline', R.item(ft, this)),
          a.collection('drawings', 'rectangle', R.item(Nt, this)),
          a.collection('drawings', 'text', R.item(m2, this)),
          a.collection('drawings', 'textbox', R.item(Kr, this))
        )
      );
    ...
    get effects() {
      return this.#e
        ...
        : (this.parent instanceof re
            ? (this.#e = new J())
            : jt(`Couldn't determine Effects for Property ${this.name}`),
          this.#e);
    }
    set effects(t) {
      this.#e = t;
    ...
    constructor(t, e) {
      ...
      Object.assign(
        ...
        g(
          ...
          a.collection('alternates', 'alternate', R.item(Er))
        )
      );
    }
    static {
  ...
  re = class {
    constructor(t, e) {
      ...
      let r = g(
          ...
          a.collection('pins', 'pin', R.item(M2, this)),
          a.object(
            'default_instance',
  ...
  ne = class {
    constructor(t, e) {
      ...
      let r = g(
          ...
          a.collection('pins', 'pin', R.item(Dr, this)),
          a.object(
            'instances',
            {},
            a.collection(
...
var ws = `(kicad_wks (version 20210606) (generator pl_editor)
  (setup
    ...
    constructor(t) {
      ...
      Object.assign(
        ...
        g(
          ...
          a.pair('generator', R.string),
          a.item('setup', o3),
          a.collection('drawings', 'line', R.item(N2, this)),
          a.collection('drawings', 'rect', R.item(Pt, this)),
          a.collection('drawings', 'polygon', R.item(Br, this)),
          a.collection('drawings', 'bitmap', R.item($r, this)),
          a.collection('drawings', 'tbtext', R.item(V2, this))
        )
      );
    }
    static {
...
function zr(s, t) {
  if (!(t == null || t == null))
    for (let e of Object.keys(t)) fs(s[e]) ? zr(s[e], t[e]) : (s[e] = t[e]);
}
l(zr, 'merge');
var ze = class s {
    constructor() {
...
var a3 = new Re('kicanvas:project'),
  Zt = class extends EventTarget {
    ...
    async load(e) {
      (a3.info(`Loading project from ${e.constructor.name}`),
        (this.settings = new ze()),
        this.#t.clear(),
        this.#r.clear(),
        (this.#e = e));
    ...
    async #s(e) {
      if ((a3.info(`Loading file ${e}`), e.endsWith('.kicad_sch')))
        return await this.#n(be, e);
      if (e.endsWith('.kicad_pcb')) return await this.#n(Pe, e);
      if (e.endsWith('.kicad_pro')) return this.#l(e);
      a3.warn(`Couldn't load ${e}: unknown file type`);
    }
    async #n(e, r) {
      if (this.#t.has(r)) return this.#t.get(r);
      let i = await this.#o(r),
        n = new e(r, i);
      if (((n.project = this), this.#t.set(r, n), n instanceof Pe)) {
    ...
    async #l(e) {
      let r = await this.#o(e),
        i = JSON.parse(r);
      this.settings = ze.load(i);
    }
    async #o(e) {
      return await (await this.#e.get(e)).text();
    }
    #c() {
      a3.info('Determining schematic hierarchy');
      let e = new Map(),
        r = new Map();
      ...
      let c = new Set(ys(this.#r.values(), (u) => u.filename));
      for (let u of this.schematics())
        if (!c.has(u.filename)) {
          let p = new Wt(
            this,
    ...
    *boards() {
      for (let e of this.#t.values()) e instanceof Pe && (yield e);
    }
    get has_boards() {
      return $t(this.boards()) > 0;
    }
    *schematics() {
      for (let e of this.#t.values()) e instanceof be && (yield e);
    }
    get has_schematics() {
      return $t(this.schematics()) > 0;
    }
    *pages() {
      yield* this.#r.values();
    }
    get first_page() {
      return Bt(this.pages());
    }
    ...
    async handle_server_error(t) {
      switch (t.status) {
        case 200:
          return;
        case 404:
          throw new ni(t.url, t);
        case 500:
          throw new si(t.url, await t.text(), t);
      }
    }
...
var Sn = ['kicad_pcb', 'kicad_pro', 'kicad_sch'],
  Ys = new c3(),
  Tn = new qe(),
  g2 = class s extends Oe {
    constructor(e) {
      super();
    ...
    static async fromURLs(...e) {
      let r = new Map();
      for (let i of e) {
        let n = qe.parse_url(i);
        if (!(!n || !n.owner || !n.repo)) {
          if (
            (n.type == 'root' && ((n.ref = 'HEAD'), (n.type = 'tree')),
            n.type == 'blob')
          )
            if (['kicad_sch', 'kicad_pcb'].includes($3(n.path))) {
              let o = Ys.convert_url(i),
                c = le(o);
              r.set(c, o);
            } else ((n.type = 'tree'), (n.path = ms(n.path)));
          if (n.type == 'tree') {
            let o = await Tn.repos_contents(
              n.owner,
              n.repo,
              n.path ?? '',
              n.ref
...
l(Ks, 'parseFlagAttribute');
var P2 = class extends CustomEvent {
    static {
...
window.customElements.define('kc-help-panel', oi);
var R3 = class {
  constructor(t = 'kc', e) {
    this.prefix = t;
    this.reviver = e;
...
var yn = {
  ...
  Hs = yn;
var Gs = [ai, Hs],
  Xn = new Map(Gs.map((s) => [s.name, s])),
  Se = {
    default: ai,
    by_name(s) {
      return Xn.get(s) ?? this.default;
    },
    list() {
      return Gs;
    },
...
var ue = class s extends EventTarget {
  constructor() {
    super(...arguments);
    this.storage = new R3('kc:prefs');
    this.theme = Se.default;
  ...
  save() {
    (this.storage.set('theme', this.theme.name),
      ...
      this.dispatchEvent(new u3({ preferences: this })));
  }
  load() {
    ((this.theme = Se.by_name(this.storage.get('theme', Se.default.name))),
...
ue.INSTANCE.load();
var u3 = class s extends CustomEvent {
  static {
  ...
  p3 = class extends N {
    ...
    initialContentCallback() {
      this.renderRoot.addEventListener('input', (e) => {
        let r = e.target;
        (r.name === 'theme' &&
          (W2.theme = Se.by_name(this.theme_control.value)),
          r.name === 'align-controls-kicad' &&
            (W2.alignControlsWithKiCad = r.checked),
          W2.save());
      });
    }
    render() {
                    ...
                    <kc-ui-control>
                        <label>
                            <input
                                ...
                                checked="${W2.alignControlsWithKiCad}" />
...
P([Q('[name=theme]', !0)], p3.prototype, 'theme_control', 2);
window.customElements.define('kc-preferences-panel', p3);
var h3 = class extends N {
  ...
  initialContentCallback() {
    (super.initialContentCallback(),
      ...
      de(this.renderRoot, 'kc-ui-button', 'click', (e, r) => {
...
P([lt], h3.prototype, 'change_current_project_page', 1);
window.customElements.define('kc-project-panel', h3);
var li = class extends N {
  ...
  connectedCallback() {
    (async () => (
      ...
      super.connectedCallback(),
      this.addDisposable(
        this.viewer.addEventListener(St.type, () => {
...
window.customElements.define('kc-viewer-bottom-toolbar', li);
var Te = class extends N {
  constructor() {
    super();
    this.viewerReady = new fe();
  ...
  initialContentCallback() {
    (this.project.active_page && this.load(this.project.active_page),
      ...
      de(this.renderRoot, 'kc-ui-button', 'click', (e) => {
        let r = e.target;
...
(P([L({ type: String })], Te.prototype, 'controls', 2),
  P([L({ type: String })], Te.prototype, 'controlslist', 2),
  P([L({ type: Boolean })], Te.prototype, 'sidebarcollapsed', 2));
var B = class {
    constructor(t, e, r) {
      this.center = t;
      this.radius = e;
...
var He = class {
    ...
    prep_circle(t, e, r) {
      ...
      return (
        this.add_bbox(O.from_points([i.center.add(n), i.center.sub(n)])),
        i
      );
    }
...
function y2(s, t, e) {
  ...
  var c, u, p, m, b, M, f;
  if ((r && (n = Qn(s, t, n, e)), s.length > 80 * e)) {
    ((c = p = s[0]), (u = m = s[1]));
    for (var V = e; V < i; V += e)
      ((b = s[V]),
        (M = s[V + 1]),
  ...
  return (S2(n, o, e, c, u, f, 0), o);
}
l(y2, 'earcut');
function Is(s, t, e, r, i) {
  var n, o;
  if (i === pi(s, t, e, r) > 0)
    for (n = t; n < e; n += r) o = Js(n, s[n], s[n + 1], o);
  else for (n = e - r; n >= t; n -= r) o = Js(n, s[n], s[n + 1], o);
  return (o && b3(o, o.next) && (L2(o), (o = o.next)), o);
}
l(Is, 'linkedList');
function et(s, t) {
  if (!s) return s;
  ...
  do
    if (
      ((r = !1), !e.steiner && (b3(e, e.next) || w(e.prev, e, e.next) === 0))
    ) {
      if ((L2(e), (e = t = e.prev), e === e.next)) break;
      r = !0;
    } else e = e.next;
  while (r || e !== t);
  return t;
...
l(et, 'filterPoints');
function S2(s, t, e, r, i, n, o) {
  if (s) {
    !o && n && Hn(s, r, i, n);
    for (var c = s, u, p; s.prev !== s.next; ) {
      if (((u = s.prev), (p = s.next), n ? Un(s, r, i, n) : On(s))) {
        (t.push((u.i / e) | 0),
          t.push((s.i / e) | 0),
          t.push((p.i / e) | 0),
          L2(s),
      ...
      if (((s = p), s === c)) {
        o
          ? o === 1
            ? ((s = Fn(et(s), t, e)), S2(s, t, e, r, i, n, 2))
            : o === 2 && xn(s, t, e, r, i, n)
          : S2(et(s), t, e, r, i, n, 1);
        break;
      }
...
l(Fn, 'cureLocalIntersections');
function xn(s, t, e, r, i, n) {
  var o = s;
  do {
...
function Qn(s, t, e, r) {
  ...
  for (n = 0, o = t.length; n < o; n++)
    ((c = t[n] * r),
      ...
      i.push(En(p)));
  for (i.sort(vn), n = 0; n < i.length; n++) e = wn(i[n], e);
  return e;
}
l(Qn, 'eliminateHoles');
function vn(s, t) {
...
function wn(s, t) {
  ...
  if (!e) return t;
  var r = As(e, s);
  return (et(r, r.next), et(e, e.next));
}
l(wn, 'eliminateHole');
function Yn(s, t) {
  var e = t,
  ...
  do
    (r >= e.x &&
      e.x >= p &&
      r !== e.x &&
      Tt(i < m ? r : n, i, p, m, i < m ? n : r, i, e.x, e.y) &&
      ((M = Math.abs(i - e.y) / (r - e.x)),
      T2(e, s) &&
        (M < b || (M === b && (e.x > o.x || (e.x === o.x && Kn(o, e))))) &&
        ((o = e), (b = M))),
      (e = e.next));
  while (e !== u);
  return o;
...
l(Kn, 'sectorContainsSector');
function Hn(s, t, e, r) {
  var i = s;
  do
    (i.z === 0 && (i.z = Ri(i.x, i.y, t, e, r)),
      (i.prevZ = i.prev),
      (i.nextZ = i.next),
      (i = i.next));
  while (i !== s);
  ((i.prevZ.nextZ = null), (i.prevZ = null), Gn(i));
}
l(Hn, 'indexCurve');
function Gn(s) {
  var t,
...
function Jn(s, t) {
  return (
    ...
    ((T2(s, t) &&
      ...
      (b3(s, t) && w(s.prev, s, s.next) > 0 && w(t.prev, t, t.next) > 0))
  );
}
l(Jn, 'isValidDiagonal');
function w(s, t, e) {
...
l(kn, 'middleInside');
function As(s, t) {
  var e = new ui(s.i, s.x, s.y),
    r = new ui(t.i, t.x, t.y),
    i = s.next,
    n = t.prev;
  return (
    (s.next = t),
...
l(ui, 'Node');
y2.deviation = function (s, t, e, r) {
  var i = t && t.length,
    n = i ? t[0] * e : s.length,
    o = Math.abs(pi(s, 0, n, e));
  if (i)
    for (var c = 0, u = t.length; c < u; c++) {
      var p = t[c] * e,
        m = c < u - 1 ? t[c + 1] * e : s.length;
      o -= Math.abs(pi(s, p, m, e));
    }
  var b = 0;
  ...
  Lt = class s {
    ...
    #t() {
      ...
      for (
        ...
        this[e.name] = this.uniforms[e.name] = new hi(
          this.gl,
          e.name,
          r,
          e.type
...
var tt = class {
  ...
  _3 = class s {
    ...
    static async load_shader(t) {
      this.shader = await Lt.load(t, 'polyline', bi, mi);
    }
    dispose() {
      (this.vao.dispose(),
  ...
  M3 = class s {
    ...
    set(t) {
      if (!t.length) return;
      let e = t.reduce(
          (p, m) => p + (m.points.length - 1) * tt.vertices_per_quad,
          0
        ),
        r = new Float32Array(e * 2),
        i = new Float32Array(e),
  ...
  f3 = class s {
    ...
    static async load_shader(t) {
      this.shader = await Lt.load(t, 'polygon', Ds, Cs);
    }
    dispose() {
      (this.vao.dispose(),
        this.position_buf.dispose(),
    ...
    set(t) {
      let e = 0;
      for (let u of t)
        (tt.triangulate_polygon(u), (e += u.vertices?.length ?? 0));
      let r = e / 2,
        i = new Float32Array(e),
      ...
      for (let u of t) {
        ...
        (i.set(u.vertices, o),
          (o += u.vertices.length),
          tt.populate_color_data(n, u.color, c, p * 4),
          (c += p * 4));
      }
  ...
  X2 = class {
    ...
    commit() {
      (this.#e.length &&
        ((this.#i = new f3(this.gl)), this.#i.set(this.#e), (this.#e = void 0)),
        this.#r.length &&
          ((this.#n = new M3(this.gl)),
          this.#n.set(this.#r),
          (this.#r = void 0)),
        this.#t.length &&
          ((this.#s = new _3(this.gl)),
          this.#s.set(this.#t),
          (this.#t = void 0)));
    }
    render(t, e = 0, r = 1) {
...
var N3 = class extends He {
    ...
    start_layer(e, r = 0) {
      if (this.gl == null) throw new Error('Uninitialized');
      this.#t = new _i(this, e, new X2(this.gl));
    }
    end_layer() {
...
var U2 = class {
    constructor(t) {
      this.text = t;
      ((this.root = Bs($n(t))), (this.root.is_root = !0));
    }
    static {
      l(this, 'Markup');
    }
...
`),
    ...
    get_markup_node_as_glyphs(t, e, r, i, n, o, c) {
      ...
      if (
        !t.is_root &&
        (t.subscript && ((b = new Ee()), (b.subscript = !0)),
        t.superscript && ((b = new Ee()), (b.superscript = !0)),
        (b.overbar ||= t.overbar),
        t.text)
      ) {
        let {
...
var Y = class s extends Xt {
  ...
  #r() {
    for (let t of $s) this.#t.push(zs(t));
    for (let t = 0; t < 256; t++) this.#i(t);
  }
  #i(t) {
    let e = P3[t];
    if (G(e)) this.#e.set(t, zs(e));
    else if (ce(e)) {
      let r = this.#t[e];
      this.#e.set(t, r);
  ...
  get_text_as_glyphs(t, e, r, i, n, o, c) {
    ...
    if (
      ...
      let Xe = new d(r.x + X.x + x, S.y - X.y),
        C = new d(S.x + X.x - x, S.y - X.y),
        se = new O2([[Xe, C]], O.from_points([Xe, C]));
    ...
    return (
      ...
      { bbox: nt, glyphs: V, cursor: new d(S.x, r.y) }
    );
  }
};
function W3(s) {
...
l(js, 'decode_coord_val');
function zn(s) {
  return [js(s[0]), js(s[1])];
}
l(zn, 'decode_coord');
function zs(s) {
  let t = 0,
  ...
  for (let m = 0; m < s.length; m += 2) {
    let b = [s[m], s[m + 1]],
      M = zn(b);
    if (m < 2)
      ((t = M[0] * Y.font_scale), (e = M[1] * Y.font_scale), (r = e - t));
  ...
  get_effective_text_thickness(t) {
    ...
    return (
      e < 1 &&
        ((e = t ?? 0),
        this.bold
          ? (e = qn(this.text_width))
          : e <= 1 && (e = eo(this.text_width))),
      (e = to(e, this.text_width, !0)),
      e
    );
  }
  get text_angle() {
...
`)),
    ...
    ((i.w = V.x), (i.h = V.y));
    let S = this.italic ? Math.round(p.y * Xt.italic_tilt) : 0;
    switch (this.h_align) {
      case 'left':
...
l(qn, 'get_bold_thickness');
function eo(s) {
  return Math.round(s / 8);
}
l(eo, 'get_normal_thickness');
function to(s, t, e) {
  let r = Math.round(t * (e ? 0.25 : 0.18));
  return Math.min(s, r);
}
l(to, 'clamp_thickness');
  ...
  apply_symbol_transformations(t) {
    ...
    (t.mirror_x && this.mirror_vertically(new d(0, 0)),
      ...
      (this.text_pos = this.text_pos.add(
        t.position.multiply(new d(1e4, -1e4))
      )));
  }
  ...
  rotate(t, e = !1) {
    ...
    ((this.text_pos = r.rotate_point(this.text_pos, t)),
      this.text_angle.is_horizontal
        ...
        : ((this.h_align = Ot(this.h_align, 'left', 'right')),
          (this.v_align = Ot(this.v_align, 'top', 'bottom')),
...
var S3 = class extends $ {
  ...
  get position() {
    if (this.parent) {
      ...
      return (
        (e = this.parent.transform.transform(e)),
        e.add(this.parent.position)
      );
    }
...
var ae = class {
  ...
  Ft = class {
    ...
    *query(t) {
    ...
    highlight(t) {
      let e = [];
      t && (e = gs(t).map((r) => (r instanceof ae ? r.name : r)));
      for (let r of this.#e)
...
var F2 = new Re('kicanvas:project'),
  _e = class {
    constructor(t, e) {
      this.view_painter = t;
      this.gfx = e;
  ...
  Je = class {
    ...
    paint(t) {
      (F2.debug('Painting'), F2.debug('Sorting paintable items into layers'));
      for (let e of t.items()) {
        let r = this.painter_for(e);
        if (!r) {
          F2.warn(`No painter found for ${e?.constructor.name}`);
          continue;
        }
        for (let i of r.layers_for(e)) this.layers.by_name(i)?.items.push(e);
      }
      for (let e of this.paintable_layers())
        (F2.debug(`Painting layer ${e.name} with ${e.items.length} items`),
          this.paint_layer(e));
      F2.debug('Painting complete');
    }
    *paintable_layers() {
...
var fi = class extends _e {
    ...
    paint(e, r) {
      ...
      for (let c = 0; c < r.repeat; c++) {
        let u = new d(n * c, o * c),
          [p, m] = [
            x2(i, r.start.position.add(u), r.start.anchor),
            x2(i, r.end.position.add(u), r.start.anchor),
          ];
        if (!p || !m) return;
  ...
  Ni = class extends _e {
    ...
    paint(e, r) {
      ...
      for (let c = 0; c < r.repeat; c++) {
        let u = new d(n * c, o * c),
          [p, m] = [
            x2(i, r.start.position.add(u), r.start.anchor, c > 0),
            x2(i, r.end.position.add(u), r.end.anchor, c > 0),
          ];
        if (!p || !m) return;
        let b = O.from_points([p, m]);
        this.gfx.line(
          F.from_BBox(b, r.linewidth || i.setup.linewidth, e.color)
        );
      }
    }
  },
  Vi = class extends _e {
    ...
    paint(e, r) {
      ...
      for (let c = 0; c < r.repeat; c++) {
        let u = new d(n * c, o * c),
          p = x2(r.parent, r.pos.position.add(u), r.pos.anchor);
        if (!p) return;
...
var y3 = class {
  ...
  X3 = class {
    constructor(
      ...
      n = h.white,
      o = h.white,
      c = [new y3(2.5, 10, 0.2), new y3(15, 1, 0.05)]
    ) {
      this.gfx = t;
      this.camera = e;
      this.layer = r;
...
var en = 8,
  ...
  U3 = class {
    ...
    #r(t) {
      ...
      let e = t.deltaX,
        r = t.deltaY;
      (rn.alignControlsWithKiCad
        ? e == 0 && t.ctrlKey && ([e, r] = [r, e])
        : e == 0 && t.shiftKey && ([e, r] = [r, e]),
        t.deltaMode === WheelEvent.DOM_DELTA_LINE
          ? ((e *= en), (r *= en))
          : t.deltaMode === WheelEvent.DOM_DELTA_PAGE && ((e *= O3), (r *= O3)),
        (e = Math.sign(e) * Math.min(O3, Math.abs(e))),
        (r = Math.sign(r) * Math.min(O3, Math.abs(r))),
        rn.alignControlsWithKiCad
    ...
    #s(t, e) {
      let r = new d(t * tn, e * tn).multiply(1 / this.camera.zoom),
    ...
    #n(t, e) {
      if (
        ((this.camera.zoom *= Math.exp(t * -ro)),
...
var x3 = class {
  constructor(t, e) {
    ...
    this.callback = e;
    this.ready = new Ne();
    ((this.camera = new C2(new d(0, 0), new d(0, 0), 1, new W(0))),
      (this.#e = new F3(this.renderer.canvas, () => {
...
var Q2 = class extends EventTarget {
  constructor(e, r = !0) {
    super();
    this.canvas = e;
    this.interactive = r;
  ...
  on_mouse_change(e) {
    ...
    (this.mouse_position.x != i.x || this.mouse_position.y != i.y) &&
      ...
      this.dispatchEvent(new St(this.mouse_position)));
  }
  resolve_loaded(e) {
...
P([lt], Q2.prototype, '_set_selected', 1);
var Ie = new Re('kicanvas:viewer'),
  xt = class extends Q2 {
    constructor(e, r, i) {
      super(e, r);
      this.theme = i;
    ...
    async load(e) {
      (await this.setup_finished,
        this.document != e &&
          (Ie.info(`Loading ${e.filename} into viewer`),
          (this.document = e),
          this.paint(),
          pe(async () => {
    ...
    paint() {
      this.document &&
        ...
        this.drawing_sheet || (this.drawing_sheet = f2.default()),
        ...
        new T3(this.renderer, this.layers, this.theme).paint(
          this.drawing_sheet
        ),
...
l(Le, 'virtual_layer_for');
function sn(s) {
  return s.startsWith(':');
}
l(sn, 'is_virtual');
function so(s, t) {
  return sn(t) && t.startsWith(`:${s}:`);
}
l(so, 'is_virtual_for');
function no(s) {
...
function* nn(s, t) {
  let e = !1;
  for (let r of rt) if ((r == s && (e = !0), e && (yield r), r == t)) return;
}
l(nn, 'copper_layers_between');
var Q3 = class extends Ft {
  constructor(e, r) {
    super();
    this.theme = r;
    let i = new Map();
    for (let n of e.layers) i.set(n.canonical_name, n);
    for (let n of Object.values(it)) {
      if (!sn(n) && !i.has(n)) continue;
      let o = !0,
        c = !1;
      (io.includes(n) &&
  ...
  *pad_hole_layers() {
  ...
  highlight(e) {
    ...
    let i = this.query((n) => n.name == r || so(r, n.name));
    super.highlight(i);
  }
};
var j = class extends _e {
    static {
  ...
  Pi = class extends j {
    ...
    paint(e, r) {
      ...
      (this.gfx.line(new F(n, r.width, i)),
        this.isFillValid(r.fill) && this.gfx.polygon(new I(n, i)));
    }
  },
  Wi = class extends j {
    constructor() {
      super(...arguments);
      this.classes = [We, dt, o2];
    }
    static {
      l(this, 'PolyPainter');
    }
    ...
    paint(e, r) {
      ...
      (r.width && this.gfx.line(new F([...r.pts, r.pts[0]], r.width, i)),
        this.isFillValid(r.fill) && this.gfx.polygon(new I(r.pts, i)));
    }
  },
  Zi = class extends j {
    constructor() {
  ...
  yi = class extends j {
    ...
    layers_for(e) {
      if (e.layers) {
        let r = [];
        for (let i of nn(e.layers[0], e.layers[1]))
          (r.push(Le(i, 'BBViaHoles')), r.push(Le(i, 'BBViaHoleWalls')));
        return r;
  ...
  Xi = class extends j {
    ...
    layers_for(e) {
      ...
      return (
        ...
        r.map((i) => (rt.includes(i) ? Le(i, 'Zones') : i))
      );
    }
    paint(e, r) {
...
var w3 = class extends xt {
  ...
  create_painter() {
    return new v3(this.renderer, this.layers, this.theme);
  }
  create_layer_set() {
  ...
  set page_opacity(t) {
    ((this.layers.by_name(it.drawing_sheet).opacity = t), this.draw());
  }
  zoom_to_board() {
...
var ye = class extends Es(N) {
  ...
  get themeObject() {
    return this.theme ? Se.by_name(this.theme) : ue.INSTANCE.theme;
  }
  async load(e) {
...
(P([L({ type: Boolean })], ye.prototype, 'loaded', 2),
  P([L({ type: String })], ye.prototype, 'theme', 2),
  P([L({ type: Boolean })], ye.prototype, 'disableinteraction', 2));
...
window.customElements.define('kc-board-viewer', vi);
...
(P([Q('kc-ui-menu', !0)], Qt.prototype, 'menu', 2),
  P([Q('kc-ui-text-filter-input', !0)], Qt.prototype, 'search_input_elm', 2),
  P([Q('kc-ui-filtered-list', !0)], Qt.prototype, 'item_filter_elem', 2));
window.customElements.define('kc-board-footprints-panel', Qt);
...
window.customElements.define('kc-board-info-panel', wi);
var v2 = class extends N {
  ...
  initialContentCallback() {
    (this.panel_body.addEventListener(w2.select_event, (e) => {
      let r = e.detail;
      ...
      this.panel_body.addEventListener(w2.visibility_event, (e) => {
        let r = e.detail,
...
(P([Q('kc-ui-panel-body', !0)], v2.prototype, 'panel_body', 2),
  P([Q('#presets', !0)], v2.prototype, 'presets_menu', 2));
var ke = class ke extends N {
  static {
    ...
    (super.initialContentCallback(),
      this.renderRoot.addEventListener('click', (e) => {
        ...
        let r = e.target?.closest('button'),
          i;
        (r ? (i = ke.visibility_event) : (i = ke.select_event),
          this.dispatchEvent(
            new CustomEvent(i, { detail: this, bubbles: !0 })
          ));
      }));
  }
  render() {
...
(P([L({ type: String })], ke.prototype, 'layer_name', 2),
  P([L({ type: String })], ke.prototype, 'layer_color', 2),
  P([L({ type: Boolean })], ke.prototype, 'layer_highlighted', 2),
  P([L({ type: Boolean })], ke.prototype, 'layer_visible', 2));
var w2 = ke;
window.customElements.define('kc-board-layer-control', w2);
window.customElements.define('kc-board-layers-panel', v2);
...
(P([Q('kc-ui-text-filter-input', !0)], Y2.prototype, 'search_input_elm', 2),
  P([Q('kc-ui-filtered-list', !0)], Y2.prototype, 'item_filter_elem', 2));
window.customElements.define('kc-board-nets-panel', Y2);
var Yi = class extends N {
  ...
  setup_events() {
    de(this.renderRoot, 'kc-ui-range', 'kc-ui-range:input', (e) => {
      let r = e.target,
        i = r.valueAsNumber;
      switch (r.name) {
        case 'tracks':
...
window.customElements.define('kc-board-objects-panel', Yi);
...
window.customElements.define('kc-board-properties-panel', Ki);
var Hi = class extends Te {
  static {
  ...
  can_load(t) {
    return t.document instanceof Pe;
  }
  make_viewer_element() {
...
window.customElements.define('kc-board-app', Hi);
var Y3 = class extends He {
    ...
    circle(e, r, i) {
      ...
      (c.arc(n.center.x, n.center.y, n.radius, 0, Math.PI * 2),
        this.#t.commands.push(new vt(c, o, null, 0)));
    }
    line(e, r, i) {
      let n = super.prep_line(e, r, i);
      if (!n.color || n.color.is_transparent_black) return;
      ...
      this.#t.commands.push(new vt(c, null, o, n.width));
    }
    polygon(e, r) {
      let i = super.prep_polygon(e, r);
      ...
      (o.closePath(), this.#t.commands.push(new vt(o, n, null, 0)));
    }
    get layers() {
      let e = this.#e;
      return {
  ...
  Gi = class extends Ge {
    ...
    push_path(e, r, i, n) {
      ...
      (o.path_count < 20, o.fill == r && o.stroke == i && o.stroke_width == n)
        ...
        : this.commands.push(new vt(e, r, i, n));
    }
    render(e, r, i = 1) {
...
var Ae = ((f) => (
  ...
  wt = class extends Ft {
    constructor(e) {
      super();
      this.theme = e;
      for (let r of Object.values(Ae)) this.add(new ae(this, r));
      ((this.by_name(':Interactive').visible = !1),
        (this.by_name(':Interactive').interactive = !0),
        (this.by_name(Ae.drawing_sheet).color =
          this.theme.worksheet ?? h.white));
    }
    static {
      l(this, 'LayerSet');
    }
...
var J3 = class s extends K {
  ...
  paint(e, r) {
    ...
    let i = {
        ...
        orientation: oo(r.definition.at.rotation),
      },
  ...
  draw_pin_shape(e, r) {
    let { p0: i, dir: n } = on.stem(r.position, r.orientation, r.def.length);
    on.draw(e, r.def.type, r.def.shape, r.position, i, n);
  }
  draw_name_and_number(e, r) {
    let i = r.def,
      ...
      v;
    (M > 0
      ? ((y = p ? void 0 : Yt.place_inside(M, S, u, r.orientation)),
        (v = m ? void 0 : Yt.place_above(f, b, V, u, r.orientation)))
      : ((y = p ? void 0 : Yt.place_above(f, b, S, u, r.orientation)),
        (v = m ? void 0 : Yt.place_below(f, b, S, u, r.orientation))),
      y && Yt.draw(e, o, r.position, y, i.name.effects, e.state.stroke),
      v && Yt.draw(e, c, r.position, v, i.number.effects, e.state.stroke));
  }
};
function oo(s) {
  switch (s) {
...
l(lo, 'get_symbol_body_and_pins_bbox');
  ...
  Di = class extends K {
    ...
    #e(e, r) {
      ...
      !i ||
        !n ||
        this.gfx.arc(
          new Ke(r.center, r.radius, new W(0), new W(Math.PI * 2), i, n)
        );
    }
    #t(e, r) {
      let i = this.determine_fill(e, r);
  ...
  Bi = class extends K {
    ...
    #e(e, r, i) {
      ...
      !n ||
        !o ||
        this.gfx.arc(
          new Ke(i.center, i.radius, i.start_angle, i.end_angle, n, o)
        );
    }
    #t(e, r, i) {
      let n = this.determine_fill(e, r);
  ...
  es = class extends K {
    ...
    paint(e, r) {
      ...
      let i = this.view_painter.current_symbol_transform,
        n = new Z3(r.shown_text);
      (n.apply_effects(r.effects),
        n.apply_at(r.at),
        n.apply_symbol_transformations(i),
        (n.attributes.color = this.dim_if_needed(
          this.theme.component_outline
        )));
      let o = n.world_pos;
...
var C3 = class extends xt {
  ...
  async load(t) {
    if (t instanceof be) return await super.load(t);
    this.document = null;
    let e = t.document;
    return (e.update_hierarchical_data(t.sheet_path), await super.load(e));
  }
  create_painter() {
    return new Kt(this.renderer, this.layers, this.theme);
  }
  create_layer_set() {
    return new wt(this.theme);
  }
  select(t) {
    if (
      (G(t) &&
...
window.customElements.define('kc-schematic-viewer', rs);
...
window.customElements.define('kc-schematic-info-panel', is);
  ...
  render() {
    ...
    if (!o) n = e('No item selected');
      ...
      let c = o.lib_symbol,
        ...
        p = he(o.unit_pins, (m) => m.number).map((m) =>
      ...
      let c = Array.from(o.properties.values()).map((p) => r(p.name, p.text)),
        u = he(o.pins, (p) => p.name).map((p) => r(p.name, p.shape));
      n = _`
                ${e('Basic properties')}
                ${r('X', o.at.position.x.toFixed(4), 'mm')}
                ${r('Y', o.at.position.y.toFixed(4), 'mm')}
...
window.customElements.define('kc-schematic-properties-panel', ss);
var Ht = class extends N {
  ...
  render() {
    let e = this.viewer.schematic,
      ...
      i = [],
      n = [],
      o = he(Array.from(e.symbols.values()), (u) => u.reference);
    for (let u of o) {
    ...
    let c = he(e.sheets, (u) => u.sheetname ?? u.sheetfile ?? '');
    for (let u of c) {
...
(P([Q('kc-ui-menu')], Ht.prototype, 'menu', 2),
  P([Q('kc-ui-text-filter-input', !0)], Ht.prototype, 'search_input_elm', 2),
  P([Q('kc-ui-filtered-list', !0)], Ht.prototype, 'item_filter_elem', 2));
window.customElements.define('kc-schematic-symbols-panel', Ht);
var ns = class extends Te {
  ...
  can_load(t) {
    return t.document instanceof be;
  }
  make_viewer_element() {
...
var st = class extends N {
  ...
  static {
    this.styles = [...N.styles, new Ve(D3), new Ve(an)];
  }
  #e;
  #t;
  initialContentCallback() {
    ...
    (pe(async () => {
      if (this.src) {
        let i = new De([this.src]);
        await this.setup_project(i);
        return;
      }
      if (r.length) {
        let i = await g2.fromURLs(...r);
        await this.setup_project(i);
        return;
      }
      new E2(this, async (i) => {
      ...
      this.link_input.addEventListener('input', async (i) => {
        ...
        if (!qe.parse_url(n)) return;
        let o = await g2.fromURLs(n);
        await this.setup_project(o);
        let c = new URL(window.location.href);
        (c.searchParams.set('github', n),
...
(P([L({ type: Boolean })], st.prototype, 'loading', 2),
  P([L({ type: Boolean })], st.prototype, 'loaded', 2),
  P([L({ type: String })], st.prototype, 'src', 2),
  P([Q('input[name="link"]', !0)], st.prototype, 'link_input', 2));
window.customElements.define('kc-kicanvas-shell', st);
var Me = class extends N {
  constructor() {
    super();
    this.#e = new Zt();
  ...
  async #s() {
    ...
    for (let o of this.querySelectorAll('kicanvas-source')) {
      if (o.src) {
        e.push(o.src);
        continue;
      }
      let c = o.textContent?.trim();
      if (!c) continue;
      let u = o.getAttribute('name')?.trim();
      if (!u || u.length == 0) {
        let p = (o.getAttribute('type') ?? 'schematic').toLowerCase(),
          m = 'kicad_sch';
        (p == 'board' ? (m = 'kicad_pcb') : p == 'project' && (m = 'kicad_pro'),
          (i[m] = (i[m] ?? 0) + 1),
          (u = `inline_${i[m]}.${m}`));
      }
      r[u] = c;
    }
    if (e.length == 0 && Object.keys(r).length == 0) {
      console.warn('No valid sources specified');
      return;
    }
    let n;
    return (
      Object.keys(r).length && e.length
        ? (n = new G2([new Jt(r), new De(e, this.custom_resolver)]))
        : Object.keys(r).length
          ? (n = new Jt(r))
          : (n = new De(e, this.custom_resolver)),
      await this.#n(n)
    );
  }
  async #n(e) {
...
(P([L({ type: String })], Me.prototype, 'src', 2),
  P([L({ type: Boolean })], Me.prototype, 'loading', 2),
  P([L({ type: Boolean })], Me.prototype, 'loaded', 2),
  P([L({ type: String })], Me.prototype, 'controls', 2),
  P([L({ type: String })], Me.prototype, 'controlslist', 2),
  P([L({ type: String })], Me.prototype, 'theme', 2),
  P([L({ type: String })], Me.prototype, 'zoom', 2));
window.customElements.define('kicanvas-embed', Me);
...
(P([L({ type: String })], Gt.prototype, 'src', 2),
  P([L({ type: String })], Gt.prototype, 'name', 2),
  P([L({ type: String })], Gt.prototype, 'type', 2));
window.customElements.define('kicanvas-source', Gt);
